...
@Component({
      ...
      <span class="dialog-icon" [attr.data-icon]="icon" aria-hidden="true">
        @if (icon === 'logout') {
          ...
          <svg viewBox="0 0 24 24">
            ...
            <path d="M6.1 9a7 7 0 0 1 11.5-2.3L20 9M4 15l2.4 2.3A7 7 0 0 0 17.9 15" />
          </svg>
        }
      </span>
  ...
  styles: `
    ...
    .dialog-icon[data-icon='logout'],
    .dialog-icon[data-icon='warning'] {
      background: #fff0ed;
      color: #c54737;
    }
    .dialog-icon svg {
